Vytvořte další soubor v podsložce 'Models' a nazvěte jej 'APS'. Deriv.cs". To je místo, kde
implementuje logiku pro konverzi návrhů pro prohlížení a pro kontrolu stavu
převody. Naplňte nový soubor následujícím kódem:
