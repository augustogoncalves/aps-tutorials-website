...
Metoda adminClient.getProjects vrátí všechny produkční projekty tohoto centra, 
liší se od rozhraní API pro projekty GET pro správu dat, které 
Vrátí pouze projekty, kterých se aktuální uživatel účastní.
