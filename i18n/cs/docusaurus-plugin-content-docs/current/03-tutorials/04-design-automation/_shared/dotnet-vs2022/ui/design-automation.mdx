...
V tomto okamžiku můžete spustit svůj projekt, stačí stisknout tlačítko přehrávání, mělo by se otevřít rozhraní HTML, což znamená, že váš projekt byl vytvořen správně. Žádné z tlačítek by nemělo fungovat... Pojďme dál.
