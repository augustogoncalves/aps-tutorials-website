Ve složce 'routes/' vytvořte soubor 'DesignAutomation.js'.

- Do tohoto souboru zapíšeme všechny koncové body, přidáme třídu Utils skládající se ze všech funkcí nástroje, jako je vytvoření instance SDK pro automatizaci návrhu, nahrání souboru a několik dalších užitečných funkcí, které jsou použity v této ukázce.
...
Před vytvořením aktivity musíme definovat balíček aplikací s pluginem a vybrat vhodný engine. Zkopírujte a vložte následující koncové body za utils třídu.
