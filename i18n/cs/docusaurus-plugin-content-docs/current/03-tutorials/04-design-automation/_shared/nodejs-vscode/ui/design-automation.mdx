...
V tomto okamžiku můžete spustit svůj projekt, stačí stisknout F5, otevřít prohlížeč a zadat [http://localhost:8080](http://localhost:8080) 
Zobrazí se rozhraní html, které označuje, že váš projekt byl vytvořen správně. Žádné z tlačítek by nemělo fungovat... Pojďme dál.
