...
Teď napíšeme koncové body pro vytvoření nové aktivity a získání existujících aktivit, zkopírujte následující kód do souboru DesignAutomation.js před posledním řádkem module.exports = router;'
