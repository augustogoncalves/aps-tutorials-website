V podsložce Controllers vytvořte soubor HubsController.cs s následujícím obsahem:
...
Kontroler zpracovává několik koncových bodů pro procházení obsahu v jiných zařízeních založených na APS
aplikace jako BIM 360 Docs a ACC. Tyto koncové body využijeme, když
sestavení části uživatelského rozhraní aplikace.