...
이 시점에서 프로젝트를 실행하고 F5 키를 누르고 브라우저를 열고 [http://localhost:8080](http://localhost:8080)를 입력하면 됩니다. 
프로젝트가 올바르게 생성되었음을 나타내는 html 인터페이스가 표시됩니다. 어떤 버튼도 작동하지 않아야 합니다... 앞으로 나아갑시다.
