Cree un archivo 'HubsController.cs' en la subcarpeta 'Controladores' con el siguiente contenido:
...
El controlador maneja varios puntos finales para examinar el contenido en otros basados en APS
aplicaciones como BIM 360 Docs y ACC. Haremos uso de estos puntos finales cuando
crear la parte de la interfaz de usuario de la aplicación.