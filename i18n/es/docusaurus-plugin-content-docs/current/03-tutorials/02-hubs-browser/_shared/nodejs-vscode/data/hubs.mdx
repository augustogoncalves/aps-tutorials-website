Implementemos la lógica para navegar a través de los hubs, proyectos, carpetas, elementos,
y versiones. Agregue el siguiente código al final del archivo 'services/aps.js':
