...
En este punto puedes ejecutar tu proyecto, solo tienes que darle al play, la interfaz HTML debería abrirse, lo que indica que tu proyecto se creó correctamente. Ninguno de los botones debería funcionar... Sigamos adelante.
