Dentro de la carpeta 'routes/' crea el archivo 'DesignAutomation.js'.

- En este archivo escribiremos todos los puntos finales, agregaremos la clase Utils que consta de todas las funciones de utilidad, como la creación de una instancia de SDK de automatización de diseño, la carga de archivos y algunas funciones útiles más que se utilizan en este ejemplo.
...
Antes de crear la actividad, debemos definir el paquete de aplicación con el complemento y seleccionar el motor adecuado. Copie y pegue los siguientes puntos finales después de la clase utils.
