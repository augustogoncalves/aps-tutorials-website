...
Ahora escribiremos puntos finales para crear una nueva actividad y obtener las actividades existentes, copie el siguiente código en el archivo 'DesignAutomation.js' antes de la última línea 'module.exports = router;'
