Las siguientes API deben agregarse al archivo 'DesignAutomation.js' antes de la última línea 'module.exports = router;'

- StartWorkitem

Aquí es donde realmente comenzamos el proceso de automatización del diseño. Este punto de conexión también carga el archivo de entrada en un depósito de OSS y define que la salida debe guardarse en el mismo depósito. Para ayudarle a identificar los archivos, tanto la entrada como la salida utilizan el mismo nombre de archivo original, pero con un sufijo (entrada o salida) más una marca de tiempo.
