...
En este punto, puede ejecutar su proyecto, simplemente presione F5, abra el navegador e ingrese [http://localhost:8080](http://localhost:8080) 
Se muestra la interfaz html que indica que el proyecto se creó correctamente. Ninguno de los botones debería funcionar... Sigamos adelante.
