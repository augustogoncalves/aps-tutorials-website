...
Este archivo inicia un servidor exprés. En la carpeta raíz, cree un archivo 'start.js' con



:::caution

Los nombres de archivo distinguen entre mayúsculas y minúsculas para algunas implementaciones, como Heroku. Para este tutorial, usemos minúsculas.
...
Este archivo sirve archivos estáticos (e.g. html) y enruta las solicitudes de API. En la carpeta raíz, cree un archivo llamado "server.js" con el siguiente contenido.
...
En la carpeta raíz, cree un archivo llamado "socket.io.js" con el siguiente contenido.
...
En la carpeta raíz, cree un archivo llamado 'config.js' con el siguiente contenido.
...
Aquí estamos usando las variables de entorno. Al momento de ejecutar nuestro servidor Express, los valores de estas variables se utilizarán para conectarse a APS.

Ahora cree una subcarpeta 'common' en la carpeta routes y prepare un archivo 'routes/common/oauth.js' que realmente solicitará el token de acceso de APS. Esto se reutilizará en otras partes de este tutorial.

- rutas/común/oauth.js
...
¡El proyecto está listo! En este punto, tu proyecto debería verse así:
