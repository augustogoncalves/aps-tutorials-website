Cree otro archivo en la subcarpeta 'Modelos' y llámelo 'APS. Deriv.cs'. Aquí es donde
implementará la lógica para convertir diseños para su visualización y para verificar el estado de
las conversiones. Rellene el nuevo archivo con el siguiente código:
