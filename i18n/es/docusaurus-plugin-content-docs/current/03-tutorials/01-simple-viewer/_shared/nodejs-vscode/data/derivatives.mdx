Implementemos la lógica para convertir diseños para verlos y para verificar el estado de
las conversiones. Agregue el siguiente código al final del archivo 'services/aps.js':
