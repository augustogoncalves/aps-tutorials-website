...
La méthode adminClient.getProjects va renvoyer tous les projets de production de ce hub, 
il est différent de l’API GET Projects de gestion des données qui 
renvoie uniquement les projets auxquels l’utilisateur actuel est impliqué.
