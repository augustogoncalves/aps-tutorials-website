Implémentons la logique de navigation dans les différents hubs, projets.
...
Et puis ajoutez le code suivant à la fin du fichier 'services/aps.js' :
...
La méthode dataManagementClient.getHubProjects() renverra les projets qui 
l’utilisateur actuel est impliqué, il est différent de l’API ACC Admin GET Projects qui 
Renvoie tous les projets, y compris ceux auxquels l’utilisateur n’est pas impliqué.
