...
À ce stade, vous pouvez exécuter votre projet, appuyez simplement sur play, l’interface HTML devrait s’ouvrir, indiquant que votre projet a été créé correctement. Aucun des boutons ne devrait fonctionner... Allons de l’avant.
