...
Maintenant, nous allons écrire des points de terminaison pour créer une nouvelle activité et obtenir les activités existantes, copier le code suivant dans le fichier 'DesignAutomation.js' avant la dernière ligne 'module.exports = router ;'
