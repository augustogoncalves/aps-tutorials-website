...
À ce stade, vous pouvez exécuter votre projet, appuyez simplement sur F5, ouvrez le navigateur et entrez [http://localhost:8080](http://localhost:8080) 
L’interface html s’affiche indiquant que votre projet a été créé correctement. Aucun des boutons ne devrait fonctionner... Allons de l’avant.
