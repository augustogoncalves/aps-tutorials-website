...
Le contrôleur gère plusieurs points de terminaison différents :
...
- 'GET /api/auth/token' générera un jeton d’accès public qui sera ensuite utilisé par le Viewer
pour charger nos designs
