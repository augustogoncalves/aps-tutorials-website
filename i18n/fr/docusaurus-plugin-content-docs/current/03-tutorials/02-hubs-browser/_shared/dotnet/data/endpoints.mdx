Créez un fichier 'HubsController.cs' sous le sous-dossier 'Controllers' avec le contenu suivant :
...
Le contrôleur gère plusieurs points de terminaison pour parcourir le contenu dans d’autres applications basées sur APS
des applications telles que BIM 360 Docs et ACC. Nous utiliserons ces points de terminaison lorsque
la création de la partie interface utilisateur de l’application.