Implémentons la logique de conversion des conceptions pour la visualisation et pour vérifier l’état de
les conversions. Ajoutez le code suivant à la fin du fichier 'services/aps.js' :
