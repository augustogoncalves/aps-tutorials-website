Crie um arquivo 'HubsController.cs' na subpasta 'Controladores' com o seguinte conteúdo:
...
O controlador manipula vários pontos de extremidade para navegar pelo conteúdo em outros baseados em APS
aplicações como BIM 360 Docs e ACC. Faremos uso desses endpoints quando
criando a parte da interface do usuário do aplicativo.