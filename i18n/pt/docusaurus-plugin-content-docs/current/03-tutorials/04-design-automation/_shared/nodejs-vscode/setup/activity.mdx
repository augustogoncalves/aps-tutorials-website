...
Agora vamos escrever endpoints para criar nova atividade e obter as atividades existentes, copie o seguinte código no arquivo 'DesignAutomation.js' antes da última linha 'module.exports = router;'
