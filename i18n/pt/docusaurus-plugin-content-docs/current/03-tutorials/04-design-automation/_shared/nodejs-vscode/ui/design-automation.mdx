...
Neste ponto você pode executar seu projeto, basta pressionar F5, abrir o navegador e digitar [http://localhost:8080](http://localhost:8080) 
A interface html é exibida indicando que seu projeto foi criado corretamente. Nenhum dos botões deve funcionar... vamos em frente.
