...
Esse arquivo inicia um servidor expresso. Na pasta raiz, crie um arquivo 'start.js' com



:::caution

Os nomes de arquivo diferenciam maiúsculas de minúsculas para algumas implantações, como a Heroku. Para este tutorial, vamos usar letras minúsculas.
...
Esse arquivo serve arquivos estáticos (e.g. html) e roteia solicitações de API. Na pasta raiz, crie um arquivo chamado 'server.js' com o seguinte conteúdo.
...
Na pasta raiz, crie um arquivo chamado 'socket.io.js' com o seguinte conteúdo.
...
Na pasta raiz, crie um arquivo chamado 'config.js' com o seguinte conteúdo.
...
Estamos usando as variáveis de ambiente aqui. No momento da execução do nosso servidor Express, os valores dessas variáveis serão usados para se conectar ao APS.

Agora crie uma subpasta 'comum' na pasta rotas e prepare um arquivo 'routes/common/oauth.js' que realmente solicitará o token de acesso do APS. Isso será reutilizado em outras partes deste tutorial.

- rotas/comuns/oauth.js
...
O projeto está pronto! Neste ponto, seu projeto deve ser assim:
