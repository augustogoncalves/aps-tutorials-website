...
O método adminClient.getProjects retornará todos os projetos de produção desse hub, 
é diferente da API de Projetos GET de Gerenciamento de Dados, que 
retorna apenas os projetos que o usuário atual está envolvido.
