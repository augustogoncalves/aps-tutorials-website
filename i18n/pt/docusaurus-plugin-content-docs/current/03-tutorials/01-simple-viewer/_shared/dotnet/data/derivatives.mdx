Crie outro arquivo na subpasta 'Modelos' e chame-o de 'APS'. Deriv.cs'. É aqui que
implementará a lógica para converter designs para visualização e para verificar o status de
as conversões. Preencha o novo arquivo com o seguinte código:
